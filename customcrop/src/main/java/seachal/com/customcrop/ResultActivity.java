...
//                .placeholder(R.color.color_f6)
        ...
        Glide.with(getApplicationContext())
                ...
                .apply(optionsglide)
                .into(imageView);
        imageView.setBackgroundColor(ContextCompat.getColor(getApplicationContext() ,R.color.colorAccent));

        ImageView iv_crop_result2 = findViewById(R.id.iv_crop_result2);
        iv_crop_result2.setImageURI(uri);
    }
